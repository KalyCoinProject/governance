...
contract GovernorAlpha {
    ...
    string public constant name = "Kalyswap Governor Alpha";

    /// @notice The number of votes required in order for a voter to become a proposer
    function proposalThreshold() public pure returns (uint) { return 1_000_000e18; } // 1,000,000 KSWAP
    ...
    /// @notice The address of the Kalyswap Protocol Timelock
    TimelockInterface public timelock;

    /// @notice The address of the Kalyswap governance token
    ...
    constructor(address timelock_, address kswap_, address guardian_) public {
