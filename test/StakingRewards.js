...
describe('StakingRewards', function () {
    before(async function () {
        ...
        this.LpToken = await ethers.getContractFactory("Kswap");
    ...
    beforeEach(async function () {
        ...
        this.stakingRewards = await this.StakingRewards.deploy(this.kswap.address, this.lpToken.address);
    ...
    describe("startVesting", function () {
        it('Start vesting successfully', async function () {
            ...
            await this.kswap.transfer(this.stakingRewards.address, vestAmount);
            ...
            expect(await this.kswap.balanceOf(this.addr2.address)).to.equal(actualAmount);
        ...
        it('Two stakers, same time', async function () {
            ...
            expect(await this.kswap.balanceOf(this.addr2.address)).to.equal(actualAmount);
            expect(await this.kswap.balanceOf(this.addr3.address)).to.equal(actualAmount);
        ...
        it('Two stakers, different times', async function () {
            ...
            await this.stake2.getReward();
            await this.stake3.getReward();
            expect(await this.kswap.balanceOf(this.addr2.address)).to.equal(largerAmount);
            expect(await this.kswap.balanceOf(this.addr3.address)).to.equal(smallerAmount);
        });
        ...
        it('Early withdraw, the whole second period', async function () {
            ...
            expect(await this.kswap.balanceOf(this.addr2.address)).to.equal(smallerAmount);
